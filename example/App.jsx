...
function App() {
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      cameraEntity.transform.position = new o3.Vector3(0, 0, 120);
    ...
    async function loadSpine(root) {
      const spineEntity = await engine.resourceManager.load(
        ...
        {
          urls: [
            'https://gw.alipayobjects.com/os/OasisHub/b6b1e9e7-099d-477e-9f33-fbe93419c2cc/1615360932921.json',
            'https://gw.alipayobjects.com/os/OasisHub/4311abcf-6f99-455f-93f6-47cc426a73eb/1615360932924.atlas',
            'https://gw.alipayobjects.com/zos/OasisHub/a6b462af-a2a9-462f-8d26-22a2ab5cc5d1/1615360932924.png'
          ],
          type: 'spine'
        }
      );
