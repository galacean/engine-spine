...
var GLShaderProgram = /*#__PURE__*/function () {
  ...
  _createClass(GLShaderProgram, [{
    ...
    value: function createFromSource(vertexSource, fragmentSource, attribLocSet) {
      ...
      if (gl.isContextLost()) {
        miniprogram.Logger.error("Contex lost while linking program.");
    ...
    value: function _compileShader(shaderType, shaderSource) {
      ...
      if (gl.isContextLost()) {
        miniprogram.Logger.error("Contex lost while compiling shader.");
      ...
      if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS) && !gl.isContextLost()) {
        ...
        this._engine.dispatch("compileShaderError", msg); // Logger.error( gl.getShaderInfoLog( shader ) );
...
var GLTechnique = /*#__PURE__*/function (_GLAsset) {
  ...
  _createClass(GLTechnique, [{
    ...
    value: function _uploadUniformValue(uniform, location, value) {
      ...
      switch (uniform.type) {
        case miniprogram.DataType.FLOAT:
          if (value.length) gl.uniform1fv(location, value);else gl.uniform1f(location, value);
          break;

        case miniprogram.DataType.FLOAT_ARRAY:
          gl.uniform1fv(location, value);
          break;

        case miniprogram.DataType.INT:
          if (value.length) gl.uniform1iv(location, value);else gl.uniform1i(location, value);
          break;

        case miniprogram.DataType.INT_ARRAY:
          gl.uniform1iv(location, value);
          break;

        case miniprogram.DataType.FLOAT_VEC2:
          gl.uniform2f(location, value.x, value.y);
          break;

        case miniprogram.DataType.FLOAT_VEC2_ARRAY:
          gl.uniform2fv(location, value);
          break;

        case miniprogram.DataType.FLOAT_VEC3:
          gl.uniform3f(location, value.x, value.y, value.z);
          break;

        case miniprogram.DataType.FLOAT_VEC3_ARRAY:
          gl.uniform3fv(location, value);
          break;

        case miniprogram.DataType.FLOAT_VEC4:
          gl.uniform4f(location, value.x, value.y, value.z, value.w);
          break;

        case miniprogram.DataType.FLOAT_VEC4_ARRAY:
          gl.uniform4fv(location, value);
          break;

        case miniprogram.DataType.INT_VEC2:
          gl.uniform2i(location, value.x, value.y);
          break;

        case miniprogram.DataType.INT_VEC2_ARRAY:
          gl.uniform2iv(location, value);
          break;

        case miniprogram.DataType.INT_VEC3:
          gl.uniform3i(location, value.x, value.y, value.z);
          break;

        case miniprogram.DataType.INT_VEC3_ARRAY:
          gl.uniform3iv(location, value);
          break;

        case miniprogram.DataType.INT_VEC4:
          gl.uniform4i(location, value.x, value.y, value.z, value.w);
          break;

        case miniprogram.DataType.INT_VEC4_ARRAY:
          gl.uniform4iv(location, value);
          break;

        case miniprogram.DataType.FLOAT_MAT2:
          gl.uniformMatrix2fv(location, false, value.elements);
          break;

        case miniprogram.DataType.FLOAT_MAT2_ARRAY:
          gl.uniformMatrix2fv(location, false, value);
          break;

        case miniprogram.DataType.FLOAT_MAT3:
          gl.uniformMatrix3fv(location, false, value.elements);
          break;

        case miniprogram.DataType.FLOAT_MAT3_ARRAY:
          gl.uniformMatrix3fv(location, false, value);
          break;

        case miniprogram.DataType.FLOAT_MAT4:
          gl.uniformMatrix4fv(location, false, value.elements);
          break;

        case miniprogram.DataType.FLOAT_MAT4_ARRAY:
          gl.uniformMatrix4fv(location, false, value);
          break;

        case miniprogram.DataType.SAMPLER_2D:
          {
        ...
        case miniprogram.DataType.SAMPLER_2D_ARRAY:
          {
        ...
        case miniprogram.DataType.SAMPLER_CUBE:
          {
            this._uploadTexture(value, location);
        ...
        case miniprogram.DataType.SAMPLER_CUBE_ARRAY:
          {
            this._uploadTextures(value, location);
        ...
        default:
          miniprogram.Logger.warn("UNKNOWN uniform type: " + uniform.type);
          break;
      } // end of switch
 ...
 * @private
 */
var GLTexture = /*#__PURE__*/function (_GLAsset) {
  _inherits(GLTexture, _GLAsset);

  var _super = _createSuper(GLTexture);
  ...
  function GLTexture(rhi, config, type) {
    ...
    _this = _super.call(this, rhi, config);
    _this._gl = void 0;
    _this._glTexture = void 0;
    _this._config = void 0;
    _this._type = void 0;
    _this._gl = rhi.gl;
    _this._glTexture = config._glTexture;
...
var WebCanvas = /*#__PURE__*/function () {
  _createClass(WebCanvas, [{
    ...
    value: function resizeByClientSize() {
      var pixelRatio = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : miniprogramAdapter.window.devicePixelRatio;
  ...
  function WebCanvas(webCanvas) {
    ...
    this._width = void 0;
    this._height = void 0;
    this._scale = new miniprogram$1.Vector2();
  ...
  _createClass(GLAssetsCache, [{
    ...
    value: function requireObject(asset, ctor) {
      ...
      if (!cachedObject || asset.needRecreate) {
        ...
        if (this._enableCollect && asset.type === miniprogram.InternalAssetType.Cache) {
...
var GLCapability = /*#__PURE__*/function () {
  _createClass(GLCapability, [{
    ...
    get: function get() {
      if (!this._maxDrawBuffers) {
        if (this.canIUse(miniprogram.GLCapabilityType.drawBuffers)) {
    ...
    get: function get() {
      if (!this._maxAnisoLevel) {
        var ext = this._rhi.requireExtension(miniprogram.GLCapabilityType.textureFilterAnisotropic);
    ...
    get: function get() {
      if (!this._maxAntiAliasing) {
        var gl = this._rhi.gl;
        var canMSAA = this.canIUse(miniprogram.GLCapabilityType.multipleSample);
  ...
  _createClass(GLCapability, [{
    ...
    value: function canIUseCompressedTextureInternalFormat(internalType) {
      var RGBA_ASTC_4X4_KHR = miniprogram.GLCompressedTextureInternalFormat.RGBA_ASTC_4X4_KHR,
          RGBA_ASTC_12X12_KHR = miniprogram.GLCompressedTextureInternalFormat.RGBA_ASTC_12X12_KHR,
          SRGB8_ALPHA8_ASTC_4X4_KHR = miniprogram.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ASTC_4X4_KHR,
          SRGB8_ALPHA8_ASTC_12X12_KHR = miniprogram.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ASTC_12X12_KHR,
          RGB_ETC1_WEBGL = miniprogram.GLCompressedTextureInternalFormat.RGB_ETC1_WEBGL,
          R11_EAC = miniprogram.GLCompressedTextureInternalFormat.R11_EAC,
          SRGB8_ALPHA8_ETC2_EAC = miniprogram.GLCompressedTextureInternalFormat.SRGB8_ALPHA8_ETC2_EAC,
          RGB_PVRTC_4BPPV1_IMG = miniprogram.GLCompressedTextureInternalFormat.RGB_PVRTC_4BPPV1_IMG,
          RGBA_PVRTC_2BPPV1_IMG = miniprogram.GLCompressedTextureInternalFormat.RGBA_PVRTC_2BPPV1_IMG,
          RGB_S3TC_DXT1_EXT = miniprogram.GLCompressedTextureInternalFormat.RGB_S3TC_DXT1_EXT,
          RGBA_S3TC_DXT5_EXT = miniprogram.GLCompressedTextureInternalFormat.RGBA_S3TC_DXT5_EXT;
      ...
      if (internalType >= RGBA_ASTC_4X4_KHR && RGBA_ASTC_12X12_KHR <= RGBA_ASTC_12X12_KHR || internalType >= SRGB8_ALPHA8_ASTC_4X4_KHR && internalType <= SRGB8_ALPHA8_ASTC_12X12_KHR) {
        return this.canIUse(miniprogram.GLCapabilityType.astc);
      } else if (internalType === RGB_ETC1_WEBGL) {
        return this.canIUse(miniprogram.GLCapabilityType.etc1);
      } else if (internalType >= R11_EAC && internalType <= SRGB8_ALPHA8_ETC2_EAC) {
        return this.canIUse(miniprogram.GLCapabilityType.etc);
      } else if (internalType >= RGB_PVRTC_4BPPV1_IMG && internalType <= RGBA_PVRTC_2BPPV1_IMG) {
        return this.canIUse(miniprogram.GLCapabilityType.pvrtc);
      } else if (internalType >= RGB_S3TC_DXT1_EXT && internalType <= RGBA_S3TC_DXT5_EXT) {
        return this.canIUse(miniprogram.GLCapabilityType.s3tc);
      }
    ...
    value: function init() {
      ...
      var standardDerivatives = miniprogram.GLCapabilityType.standardDerivatives,
          shaderTextureLod = miniprogram.GLCapabilityType.shaderTextureLod,
          elementIndexUint = miniprogram.GLCapabilityType.elementIndexUint,
          depthTexture = miniprogram.GLCapabilityType.depthTexture,
          vertexArrayObject = miniprogram.GLCapabilityType.vertexArrayObject,
          instancedArrays = miniprogram.GLCapabilityType.instancedArrays,
          multipleSample = miniprogram.GLCapabilityType.multipleSample,
          drawBuffers = miniprogram.GLCapabilityType.drawBuffers,
          astc = miniprogram.GLCapabilityType.astc,
          astc_webkit = miniprogram.GLCapabilityType.astc_webkit,
          etc = miniprogram.GLCapabilityType.etc,
          etc_webkit = miniprogram.GLCapabilityType.etc_webkit,
          etc1 = miniprogram.GLCapabilityType.etc1,
          etc1_webkit = miniprogram.GLCapabilityType.etc1_webkit,
          pvrtc = miniprogram.GLCapabilityType.pvrtc,
          pvrtc_webkit = miniprogram.GLCapabilityType.pvrtc_webkit,
          s3tc = miniprogram.GLCapabilityType.s3tc,
          s3tc_webkit = miniprogram.GLCapabilityType.s3tc_webkit,
          textureFloat = miniprogram.GLCapabilityType.textureFloat,
          textureHalfFloat = miniprogram.GLCapabilityType.textureHalfFloat,
          textureFloatLinear = miniprogram.GLCapabilityType.textureFloatLinear,
          textureHalfFloatLinear = miniprogram.GLCapabilityType.textureHalfFloatLinear,
          WEBGL_colorBufferFloat = miniprogram.GLCapabilityType.WEBGL_colorBufferFloat,
          colorBufferFloat = miniprogram.GLCapabilityType.colorBufferFloat,
          colorBufferHalfFloat = miniprogram.GLCapabilityType.colorBufferHalfFloat,
          textureFilterAnisotropic = miniprogram.GLCapabilityType.textureFilterAnisotropic;
    ...
    value: function compatibleInterface(capabilityType, flatItem) {
      ...
      if (ext = rhi.requireExtension(capabilityType)) {
        for (var _glKey in flatItem) {
          ...
          var extensionVal = ext[_extensionKey]; // 小程序 hack 了原生的 Function，用是否有 .bind 去判断是否是 Function
    ...
    value: function compatibleAllInterface() {
      // 需要兼容的能力
      var depthTexture = miniprogram.GLCapabilityType.depthTexture,
          vertexArrayObject = miniprogram.GLCapabilityType.vertexArrayObject,
          instancedArrays = miniprogram.GLCapabilityType.instancedArrays,
          drawBuffers = miniprogram.GLCapabilityType.drawBuffers,
          textureFilterAnisotropic = miniprogram.GLCapabilityType.textureFilterAnisotropic,
    ...
    get: function get() {
      return this.canIUse(miniprogram.GLCapabilityType.textureFloat) && this.rhi.renderStates.getParameter(this.rhi.gl.MAX_VERTEX_TEXTURE_IMAGE_UNITS) > 0;
    }
  }]);
...
var GLPrimitive = /*#__PURE__*/function () {
  function GLPrimitive(rhi, primitive) {
    ...
    this.canUseInstancedArrays = rhi.canIUse(miniprogram.GLCapabilityType.instancedArrays);
    this._useVao = rhi.canIUse(miniprogram.GLCapabilityType.vertexArrayObject);
    this.gl = rhi.gl;
  }
  /**
   * 执行绘制操作。
    ...
    value: function draw(tech, subPrimitive) {
      ...
      if (!instanceCount) {
        ...
        if (this.canUseInstancedArrays) {
          ...
          miniprogram.Logger.error("ANGLE_instanced_arrays extension is not supported");
        }
      } // unbind
    ...
    value: function bindBufferAndAttrib(tech) {
      ...
      for (var name in techAttributes) {
        ...
        if (element) {
          ...
          miniprogram.Logger.warn("vertex attribute not found: " + name);
        }
      }
  ...
  _createClass(GLSprite, [{
    ...
    value: function drawSprite(positionQuad, uvRect, tintColor) {
      ...
      if (this._drawSpriteCount > this._maxBatchCount) {
        miniprogram.Logger.warn("Sprite: sprite count overflow");
        return;
      }
      ...
      this._pushVertex(positionQuad.leftTop, new miniprogram$1.Vector2(u, v), color);

      this._pushVertex(positionQuad.leftBottom, new miniprogram$1.Vector2(u, q), color);

      this._pushVertex(positionQuad.rightBottom, new miniprogram$1.Vector2(p, q), color);

      this._pushVertex(positionQuad.rightBottom, new miniprogram$1.Vector2(p, q), color);

      this._pushVertex(positionQuad.rightTop, new miniprogram$1.Vector2(p, v), color);
...
var SpriteTechnique = {
  ...
  attributes: {
    a_pos: {
      name: "a_pos",
      semantic: "POSITION",
      type: miniprogram.DataType.FLOAT_VEC3
    },
    a_uv: {
      name: "a_uv",
      semantic: "TEXCOORD_0",
      type: miniprogram.DataType.FLOAT_VEC2
    },
    a_color: {
      name: "a_color",
      semantic: "COLOR",
  ...
  uniforms: {
    matProjection: {
      name: "matProjection",
      semantic: miniprogram.UniformSemantic.PROJECTION,
      type: miniprogram.DataType.FLOAT_MAT4
    },
    matView: {
      name: "matView",
      semantic: miniprogram.UniformSemantic.VIEW,
      type: miniprogram.DataType.FLOAT_MAT4
    },
    s_diffuse: {
      name: "s_diffuse",
      type: miniprogram.DataType.SAMPLER_2D
    }
  },
  states: {
    disable: [miniprogram.RenderState.CULL_FACE],
    enable: [miniprogram.RenderState.BLEND],
    functions: {
      blendFunc: [miniprogram.BlendFunc.SRC_ALPHA, miniprogram.BlendFunc.ONE_MINUS_SRC_ALPHA],
  ...
  _createClass(GLSpriteBatcher, [{
    ...
    value: function flush() {
      ...
      if (!this._targetTexture) {
        miniprogram.Logger.error("No texture!");
        return;
      }
...
var WebGLRenderer = /*#__PURE__*/function () {
  ...
  _createClass(WebGLRenderer, [{
    ...
    value: function clearRenderTarget(clearMode, clearParam) {
      ...
      switch (clearMode) {
        case miniprogram.ClearMode.SOLID_COLOR:
          // solid color
          gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
          gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
          break;

        case miniprogram.ClearMode.DEPTH_ONLY:
          // depth only
          gl.clear(gl.DEPTH_BUFFER_BIT);
          break;

        case miniprogram.ClearMode.COLOR_ONLY:
          gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
          gl.clear(gl.COLOR_BUFFER_BIT);
          break;

        case miniprogram.ClearMode.STENCIL_ONLY:
          gl.clear(gl.STENCIL_BUFFER_BIT);
          break;

        case miniprogram.ClearMode.ALL_CLEAR:
          gl.clearColor(clearParam.x, clearParam.y, clearParam.z, clearParam.w);
          gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT | gl.STENCIL_BUFFER_BIT);
          break;

        case miniprogram.ClearMode.DONT_CLEAR:
          // dont clear
          break;
      }
    }
    ...
    value: function drawPrimitive(primitive, group, mtl) {
      ...
      if (primitive && glTech) {
        ...
        miniprogram.Logger.error("draw primitive failed.");
      }
    }
    /**
