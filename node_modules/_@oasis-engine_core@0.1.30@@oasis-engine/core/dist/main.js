 ...
 * 引擎对象。
 */
var EngineObject = function EngineObject() {
...
var EventDispatcher = /*#__PURE__*/function (_EngineObject) {
  ...
  _createClass(EventDispatcher, [{
    ...
    key: "hasEvent",
    value: function hasEvent(type, listener) {
      var listeners = this._listeners;
    ...
    value: function trigger(event) {
      ...
      if (listenersArray) {
        ...
        var copiedListeners = listenersArray.slice(); // then loop copied array instead of original listeners

        for (var i = 0, l = copiedListeners.length; i !== l; ++i) {
          var listener = copiedListeners[i];
...
(function (IntersectInfo) {
  IntersectInfo[IntersectInfo["EXCLUDE"] = 0] = "EXCLUDE";
  IntersectInfo[IntersectInfo["INTERSECT"] = 1] = "INTERSECT";
  IntersectInfo[IntersectInfo["INCLUDE"] = 2] = "INCLUDE";
})(exports.IntersectInfo || (exports.IntersectInfo = {}));
/**
 * GL 层能力
...
var ResourceManager = /*#__PURE__*/function () {
  ...
  function ResourceManager(engine) {
    ...
    this._referenceObjectPool = Object.create(null);
  ...
  _createClass(ResourceManager, [{
    ...
    value: function cancelNotLoaded(url) {
      ...
      if (!url) {
        Object.values(this._loadingPromises).forEach(function (promise) {
          promise.cancel();
        });
    ...
    key: "gc",
    value: function gc() {
      var objects = Object.values(this._referenceObjectPool);
      objects.sort(function (refObj1, refObj2) {
        return refObj1.gcPriority - refObj2.gcPriority;
      });
    ...
    key: "_addReferenceObject",
    value: function _addReferenceObject(id, asset) {
    ...
    key: "_deleteReferenceObject",
    value: function _deleteReferenceObject(id) {
...
var Component = /*#__PURE__*/function (_EventDispatcher) {
  ...
  _createClass(Component, [{
    ...
    key: "_cloneTo",
    value: function _cloneTo(desComponent) {} //---------------------------------------------Deprecated-----------------------------------------------------------------
...
var UpdateFlag = /*#__PURE__*/function () {
  ...
  _createClass(UpdateFlag, [{
    key: "destroy",
    value: function destroy() {
      var flags = this._flags; // avoid repeated destroy
...
var Transform = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Transform, [{
    ...
    set: function set(value) {
      ...
      if (parent) {
        o3Math.Matrix.invert(parent.worldMatrix, Transform._tempMat41);
        o3Math.Vector3.transformCoordinate(value, Transform._tempMat41, this._position);
      } else {
        value.cloneTo(this._position);
      }
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._LOCAL_EULER_FLAG)) {
        ...
        this._rotation.scale(o3Math.MathUtil.radToDegreeFactor); // 弧度转角度
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._WORLD_EULER_FLAG)) {
        ...
        this._worldRotation.scale(o3Math.MathUtil.radToDegreeFactor); // 弧度转角度
    ...
    set: function set(value) {
      ...
      o3Math.Quaternion.rotationEuler(o3Math.MathUtil.degreeToRadian(value.x), o3Math.MathUtil.degreeToRadian(value.y), o3Math.MathUtil.degreeToRadian(value.z), this._worldRotationQuaternion);
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._LOCAL_QUAT_FLAG)) {
        o3Math.Quaternion.rotationEuler(o3Math.MathUtil.degreeToRadian(this._rotation.x), o3Math.MathUtil.degreeToRadian(this._rotation.y), o3Math.MathUtil.degreeToRadian(this._rotation.z), this._rotationQuaternion);
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._WORLD_QUAT_FLAG)) {
        ...
        if (parent != null) {
          o3Math.Quaternion.multiply(parent.worldRotationQuaternion, this.rotationQuaternion, this._worldRotationQuaternion);
        } else {
    ...
    set: function set(value) {
      ...
      if (parent) {
        o3Math.Quaternion.invert(parent.worldRotationQuaternion, Transform._tempQuat0);
        o3Math.Quaternion.multiply(value, Transform._tempQuat0, this._rotationQuaternion);
      } else {
        value.cloneTo(this._rotationQuaternion);
      }
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._LOCAL_MATRIX_FLAG)) {
        o3Math.Matrix.affineTransformation(this._scale, this.rotationQuaternion, this._position, this._localMatrix);
    ...
    get: function get() {
      if (this._isContainDirtyFlag(Transform._WORLD_MATRIX_FLAG)) {
        ...
        if (parent) {
          o3Math.Matrix.multiply(parent.worldMatrix, this.localMatrix, this._worldMatrix);
        } else {
    ...
    set: function set(value) {
      ...
      if (parent) {
        o3Math.Matrix.invert(parent.worldMatrix, Transform._tempMat42);
        o3Math.Matrix.multiply(value, Transform._tempMat42, this._localMatrix);
      } else {
        value.cloneTo(this._localMatrix);
      }
  ...
  function Transform(entity) {
    ...
    _this._position = new o3Math.Vector3();
    _this._rotation = new o3Math.Vector3();
    _this._rotationQuaternion = new o3Math.Quaternion();
    _this._scale = new o3Math.Vector3(1, 1, 1);
    _this._worldPosition = new o3Math.Vector3();
    _this._worldRotation = new o3Math.Vector3();
    _this._worldRotationQuaternion = new o3Math.Quaternion();
    _this._lossyWorldScale = new o3Math.Vector3(1, 1, 1);
    _this._localMatrix = new o3Math.Matrix();
    _this._worldMatrix = new o3Math.Matrix();
  ...
  _createClass(Transform, [{
    ...
    value: function translate(translation) {
      ...
      if (relativeToLocal) {
        ...
        o3Math.Matrix.rotationQuaternion(this.rotationQuaternion, rotationMat);
        o3Math.Vector3.transformCoordinate(translation, rotationMat, Transform._tempVec3);
    ...
    value: function rotateXYZ(x, y, z) {
      var relativeToLocal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      var radFactor = o3Math.MathUtil.degreeToRadFactor;
      var rotQuat = Transform._tempQuat0;
      o3Math.Quaternion.rotationEuler(x * radFactor, y * radFactor, z * radFactor, rotQuat);
    ...
    value: function rotateByAxis(axis, angle) {
      ...
      var rad = angle * o3Math.MathUtil.degreeToRadFactor;
      o3Math.Quaternion.rotationAxisAngle(axis, rad, Transform._tempQuat0);
    ...
    value: function lookAt(worldPosition, worldUp) {
      ...
      var EPSILON = o3Math.MathUtil.zeroTolerance;

      if ( //todo:如果数学苦做保护了的话，可以删除
      Math.abs(position.x - worldPosition.x) < EPSILON && Math.abs(position.y - worldPosition.y) < EPSILON && Math.abs(position.z - worldPosition.z) < EPSILON) {
        return;
      }

      worldUp = (_worldUp = worldUp) !== null && _worldUp !== void 0 ? _worldUp : Transform._tempVec3.setValue(0, 1, 0);
      var mat = Transform._tempMat43;
      o3Math.Matrix.lookAt(position, worldPosition, worldUp, mat); //CM:可采用3x3矩阵优化
    ...
    key: "_cloneTo",
    value: function _cloneTo(target) {
    ...
    value: function _getScaleMatrix() {
      ...
      o3Math.Quaternion.invert(this.worldRotationQuaternion, invRotation);
      o3Math.Matrix3x3.rotationQuaternion(invRotation, invRotationMat);
      o3Math.Matrix3x3.multiply(invRotationMat, worldRotScaMat, scaMat);
      return scaMat;
    }
  }, {
    ...
    value: function _rotateByQuat(rotateQuat, relativeToLocal) {
      if (relativeToLocal) {
        o3Math.Quaternion.multiply(this.rotationQuaternion, rotateQuat, this._rotationQuaternion);
        this.rotationQuaternion = this._rotationQuaternion;
      } else {
        o3Math.Quaternion.multiply(this.worldRotationQuaternion, rotateQuat, this._worldRotationQuaternion);
        this.worldRotationQuaternion = this._worldRotationQuaternion;
      }
    }
  }]);
...
Transform._tempQuat0 = new o3Math.Quaternion();
Transform._tempVec3 = new o3Math.Vector3();
Transform._tempMat30 = new o3Math.Matrix3x3();
Transform._tempMat31 = new o3Math.Matrix3x3();
Transform._tempMat32 = new o3Math.Matrix3x3();
Transform._tempMat40 = new o3Math.Matrix();
Transform._tempMat41 = new o3Math.Matrix();
Transform._tempMat42 = new o3Math.Matrix();
Transform._tempMat43 = new o3Math.Matrix();
Transform._LOCAL_EULER_FLAG = 0x1;
Transform._LOCAL_QUAT_FLAG = 0x2;
Transform._WORLD_POSITION_FLAG = 0x4;
Transform._WORLD_EULER_FLAG = 0x8;
Transform._WORLD_QUAT_FLAG = 0x10;
Transform._WORLD_SCALE_FLAG = 0x20;
Transform._LOCAL_MATRIX_FLAG = 0x40;
Transform._WORLD_MATRIX_FLAG = 0x80;
Transform._WM_WP_FLAGS = 0x84;
Transform._WM_WE_WQ_FLAGS = 0x98;
Transform._WM_WP_WE_WQ_FLAGS = 0x9c;
Transform._WM_WS_FLAGS = 0xa0;
Transform._WM_WP_WS_FLAGS = 0xa4;
Transform._WM_WP_WE_WQ_WS_FLAGS = 0xbc;
...
var Entity = /*#__PURE__*/function (_EventDispatcher) {
  ...
  _createClass(Entity, [{
    ...
    set: function set(value) {
      if (value !== this._isActive) {
        ...
        if (value) {
          ...
          if ((parent === null || parent === void 0 ? void 0 : parent._isActiveInHierarchy) || this._isRoot && this._scene._isActiveInEngine) {
            this._processActive();
          }
        } else {
    ...
    value: function findByName(name) {
      var _entitys = Entity._entitys;
      var elements = _entitys._elements;

      for (var i = _entitys.length - 1; i >= 0; i--) {
        var _entity = elements[i];
        var nodeName = _entity.name;
    ...
    key: "findByPath",
    value: function findByPath(path, scene) {
      var _Engine$_lastCreateEn;

      scene || (scene = (_Engine$_lastCreateEn = Engine._lastCreateEngine) === null || _Engine$_lastCreateEn === void 0 ? void 0 : _Engine$_lastCreateEn.sceneManager.activeScene);

      if (scene) {
        var splits = path.split("/").filter(Boolean);

        for (var i = 0, n = scene.rootEntitiesCount; i < n; i++) {
          var findEntity = scene.getRootEntity(i);
  ...
  _createClass(Entity, [{
    ...
    value: function addComponent(type) {
      ...
      var component = new type(this, props);
    ...
    value: function createChild(name) {
      var child = new Entity(name, this.engine);
      child.parent = this;
      return child;
    }
    /**
    ...
    value: function clone() {
      var newNode = new Entity(this.name, this._engine);
      newNode._isActive = this._isActive;
      newNode.transform.localMatrix = this.transform.localMatrix;
      var children = this._children;

      for (var i = 0, _len = this._children.length; i < _len; i++) {
        var childNode = children[i];
        newNode.addChild(childNode.clone());
      }

      var abilityArray = this._components || [];
      var len = abilityArray.length;

      for (var _i = 0; _i < len; _i++) {
        var ability = abilityArray[_i];

        if (!(ability instanceof Transform)) {
          var newCom = newNode.addComponent(ability.constructor, ability._props);
    ...
    value: function getInvModelMatrix() {
      if (this._inverseWorldMatFlag.flag) {
        o3Math.Matrix.invert(this.transform.worldMatrix, this._invModelMatrix);
...
var Scene = /*#__PURE__*/function (_EventDispatcher) {
  ...
  _createClass(Scene, [{
    ...
    value: function createRootEntity(name) {
      var entity = new Entity(name, this._engine);
...
var Engine = /*#__PURE__*/function (_EventDispatcher) {
  ...
  _createClass(Engine, [{
    ...
    key: "_getDefaultEngine",

    /**
     * 当前创建对象所属的默认引擎对象。
     */
    value: function _getDefaultEngine() {
  ...
  function Engine(canvas, hardwareRenderer) {
    ...
    _this.features = [];
    Engine._lastCreateEngine = _assertThisInitialized(_this);
    ...
    _this._sceneManager.activeScene = new Scene("DefaultScene", _assertThisInitialized(_this));
    return _this;
  }
  /**
   * 创建实体。
...
Engine.defaultCreateObjectEngine = null;
Engine._lastCreateEngine = null;
 ...
 * 可渲染的组件。
 */
var RenderableComponent = /*#__PURE__*/function (_Component) {
  ...
  function RenderableComponent(entity) {
    ...
    _this = _super.call(this, entity, props);
    _this._onUpdateIndex = -1;
    _this._rendererIndex = -1;
    _this._overrideUpdate = false;
    _this._transformChangeFlag = void 0;
    _this._bounds = {
      min: new o3Math.Vector3(),
      max: new o3Math.Vector3()
    };
  ...
  _createClass(RenderableComponent, [{
    ...
    value: function _render(camera) {
      ...
      if (this.cullDistanceSq > 0) {
        var distanceSq = o3Math.Vector3.distanceSquared(camera._entity.transform.worldPosition, this.entity.transform.worldPosition);
...
var RenderPass = /*#__PURE__*/function () {
  ...
  function RenderPass() {
    ...
    var clearParam = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new o3Math.Vector4(0, 0, 0, 0);
...
var RenderContext = /*#__PURE__*/function () {
  function RenderContext() {
    ...
    this.viewProjectMatrix = new o3Math.Matrix();
  ...
  _createClass(RenderContext, null, [{
    ...
    value: function _getRenderContext(camera) {
      ...
      o3Math.Matrix.multiply(context.projectionMatrix, context.viewMatrix, context.viewProjectMatrix);
...
var RenderQueue = /*#__PURE__*/function () {
  ...
  _createClass(RenderQueue, [{
    ...
    key: "pushPrimitive",
    value: function pushPrimitive(component, primitive, mtl) {
      this._items.push({
        component: component,
        primitive: primitive,
        mtl: mtl
      ...
      if (items.length > 1) {
        this._items = items.sort(function (item1, item2) {
          if (item1.component.renderPriority === item2.component.renderPriority) {
            ...
            var dis = o3Math.Vector3.distanceSquared(pos2, eyePos) - o3Math.Vector3.distanceSquared(pos1, eyePos);
            return dis;
          } else {
    ...
    value: function sortByTechnique() {
      ...
      if (items.length > 1) {
        this._items = items.sort(function (item1, item2) {
          if (item1.component.renderPriority === item2.component.renderPriority) {
            var tech1 = item1.mtl.technique;
            var tech2 = item2.mtl.technique;
    ...
    value: function render(camera, replaceMaterial, mask) {
      ...
      for (var i = 0, len = items.length; i < len; i++) {
        ...
        if (this._isPrimitive(item)) {
          ...
          rhi.flushSprite();
          var material = replaceMaterial ? replaceMaterial : mtl;
          (_material$preRender = material.preRender) === null || _material$preRender === void 0 ? void 0 : _material$preRender.call(material, item.component, item.primitive);
          material.prepareDrawing(context, item.component, item.primitive, mtl);
          rhi.drawPrimitive(item.primitive, material);
          (_material$postRender = material.postRender) === null || _material$postRender === void 0 ? void 0 : _material$postRender.call(material, item.component, item.primitive);
        } else {
    ...
    value: function updateMaxJointsNum(items, replaceMaterial) {
      for (var i = 0, len = items.length; i < len; i++) {
        var _items$i = items[i],
            ...
            mtl = _items$i.mtl;
        var materialControl = replaceMaterial ? replaceMaterial : mtl; // 仅当 component 为 SkinnedMeshRenderer 时需要计算
...
var BasicRenderPipeline = /*#__PURE__*/function (_SceneVisitor) {
  ...
  _createClass(BasicRenderPipeline, [{
    ...
    key: "pushPrimitive",
    value: function pushPrimitive(component, primitive, mtl) {
      if (mtl.renderType === exports.MaterialType.TRANSPARENT) {
...
MathTemp.tempMat4 = new o3Math.Matrix();
MathTemp.tempVec4 = new o3Math.Vector4();
MathTemp.tempVec3 = new o3Math.Vector3();
var ClearFlags;
/**
...
var Camera = (_dec = dependencies(Transform), _dec(_class = (_temp = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Camera, [{
    ...
    get: function get() {
      ...
      if (this._isViewMatrixDirty.flag) {
        ...
        o3Math.Matrix.invert(this._transform.worldMatrix, this._viewMatrix);
      }
    ...
    get: function get() {
      ...
      if (!this._isOrthographic) {
        o3Math.Matrix.perspective(o3Math.MathUtil.degreeToRadian(this._fieldOfView), aspectRatio, this._nearClipPlane, this._farClipPlane, this._projectionMatrix);
      } else {
        var width = this._orthographicSize * aspectRatio;
        var height = this._orthographicSize;
        o3Math.Matrix.ortho(-width, width, -height, height, this._nearClipPlane, this._farClipPlane, this._projectionMatrix);
      }
  ...
  function Camera(entity, _ref) {
    var _RenderPipeline;

    var _this;

    var RenderPipeline = _ref.RenderPipeline;
    ...
    _this.priority = 0;
    _this.cullingMask = 0;
    _this._renderPipeline = void 0;
    _this._isOrthographic = false;
    _this._projectionMatrix = new o3Math.Matrix();
    _this._isProjMatSetting = false;
    _this._viewMatrix = new o3Math.Matrix();
    _this._backgroundColor = new o3Math.Vector4();
    _this._clearMode = exports.ClearMode.SOLID_COLOR;
    _this._viewport = new o3Math.Vector4(0, 0, 1, 1);
    _this._nearClipPlane = 0.1;
    _this._farClipPlane = 100;
    _this._fieldOfView = 45;
    _this._orthographicSize = 10;
    _this._inverseProjectionMatrix = new o3Math.Matrix();
    _this._inverseViewMatrix = new o3Math.Matrix();
    _this._isProjectionDirty = true;
    _this._isInvProjMatDirty = true;
    _this._customAspectRatio = undefined;
    _this._lastAspectSize = new o3Math.Vector2(0, 0);
    _this._invViewProjMat = new o3Math.Matrix();
    _this._transform = void 0;
    _this._isViewMatrixDirty = void 0;
    _this._isInvViewProjDirty = void 0;
    ...
    RenderPipeline = (_RenderPipeline = RenderPipeline) !== null && _RenderPipeline !== void 0 ? _RenderPipeline : BasicRenderPipeline;
    _this._renderPipeline = new RenderPipeline(_assertThisInitialized(_this)); // 默认设置
  ...
  _createClass(Camera, [{
    ...
    value: function worldToViewportPoint(point, out) {
      o3Math.Matrix.multiply(this.projectionMatrix, this.viewMatrix, MathTemp.tempMat4);
      MathTemp.tempVec4.setValue(point.x, point.y, point.z, 1.0);
      o3Math.Vector4.transform(MathTemp.tempVec4, MathTemp.tempMat4, MathTemp.tempVec4);
    ...
    value: function viewportPointToRay(point, out) {
      ...
      o3Math.Vector3.subtract(farPoint, origin, out.direction);
    ...
    value: function _innerViewportToWorldPoint(point, invViewProjMat, out) {
      ...
      o3Math.Vector4.transform(clipPoint, invViewProjMat, clipPoint);
    ...
    value: function setClearMode() {
      ...
      var backgroundColor = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new o3Math.Vector4(0.25, 0.25, 0.25, 1);
    ...
    get: function get() {
      if (this._isInvViewProjDirty.flag) {
        ...
        o3Math.Matrix.multiply(this.inverseViewMatrix, this.inverseProjectionMatrix, this._invViewProjMat);
      }
    ...
    get: function get() {
      if (this._isInvProjMatDirty) {
        ...
        o3Math.Matrix.invert(this.projectionMatrix, this._inverseProjectionMatrix);
      }
...
var ReferenceObject = /*#__PURE__*/function (_AssetObject) {
  _inherits(ReferenceObject, _AssetObject);

  var _super = _createSuper(ReferenceObject);
  ...
  function ReferenceObject(engine) {
    var _this;
    ...
    _this._destroyed = false;
    var resEngine = engine !== null && engine !== void 0 ? engine : Engine._getDefaultEngine();
    if (!resEngine) throw "asset must belone to an engine.";
    _this._engine = resEngine;

    resEngine.resourceManager._addReferenceObject(_this.instanceId, _assertThisInitialized(_this));
  ...
  _createClass(ReferenceObject, [{
    ...
    key: "_addToAssetManager",

    /**
     * @internal
     */
    value: function _addToAssetManager(path) {
    ...
    key: "_addReference",
    value: function _addReference(referenceCount) {
...
var _tempVec3 = new o3Math.Vector3(0, 1, 0);
/**
 * 灯光基类
 */
...
var Light = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Light, [{
    ...
    key: "viewMatrix",
    get: function get() {
      if (!this._viewMat) this._viewMat = new o3Math.Matrix();
      o3Math.Matrix.invert(this.inverseViewMatrix, this._viewMat);
    ...
    key: "inverseViewMatrix",
    get: function get() {
      if (!this._modelMat) this._modelMat = new o3Math.Matrix();
      o3Math.Matrix.rotateAxisAngle(this.entity.transform.worldMatrix, _tempVec3, Math.PI, this._modelMat);
...
var AmbientLight = /*#__PURE__*/function (_Light) {
  ...
  function AmbientLight(entity, props) {
    var _this;
    ...
    _this.name = props.name || "ambientLight";
    /**
     * 颜色
     * @member {Vector3}
     */

    _this.color = props.color || new o3Math.Vector3(1, 1, 1);
    /**
     * 光照强度
     * @member {number}
     */

    _this.intensity = props.intensity || 1.0;
    _this._lightColor = new o3Math.Vector3();
    return _this;
  }
  /** 获取环境光最终颜色
   * @return {Vector3} 颜色
  ...
  _createClass(AmbientLight, [{
    ...
    key: "lightColor",
    get: function get() {
      o3Math.Vector3.scale(this.color, this.intensity, this._lightColor);
...
var DirectLight = /*#__PURE__*/function (_Light) {
   ...
   */
  function DirectLight(entity, props) {
    var _this;

    _classCallCheck(this, DirectLight);

    _this = _super.call(this, entity);
    _this._forward = new o3Math.Vector3();
    _this._lightColor = void 0;
    _this._reverseDirection = void 0;
    _this.color = void 0;
    _this.intensity = void 0;
    _this.name = props.name || "directLight";
    /**
     * 颜色
     * @member {Vector3}
     */
    ...
    _this.intensity = props.intensity || 1.0;
    _this._lightColor = new o3Math.Vector3();
    _this._reverseDirection = new o3Math.Vector3();
    return _this;
  }
  /** 获取方向光方向
   * @return {Vector3} 方向向量
  ...
  _createClass(DirectLight, [{
    ...
    get: function get() {
      o3Math.Vector3.scale(this.direction, -1, this._reverseDirection);
...
var cacheMat3 = new o3Math.Matrix3x3();
/**
 * 环境光源
 */
...
var EnvironmentMapLight = /*#__PURE__*/function (_Light) {
  ...
  function EnvironmentMapLight(entity, props) {
    var _this;
    ...
    var name = props.name,
        ...
        diffuseIntensity = props.diffuseIntensity,
    ...
    _this.diffuse = diffuse || new o3Math.Vector3(0.3, 0.3, 0.3);
    /**
     * 单色高光
     * @member {Vector3}
     */

    _this.specular = specular || new o3Math.Vector3(0.5, 0.5, 0.5);
    /**
     * 环境光强度
     * @member {Number}
     */

    _this.diffuseIntensity = diffuseIntensity === undefined ? 1 : diffuseIntensity;
    /**
     * 高光强度
     * @member {Number}
     */

    _this.specularIntensity = specularIntensity === undefined ? 1 : specularIntensity;
    return _this;
  }
  /**
   * 是否使用diffuse贴图
...
var PointLight = /*#__PURE__*/function (_Light) {
   ...
   */
  function PointLight(entity, props) {
    var _this;
    ...
    _this.decay = void 0;
    _this._lightColor = void 0;
    _this.name = props.name || "pointLight";
    /**
     * 颜色
     * @member {Vector3}
     */
    ...
    _this.distance = props.distance !== undefined ? props.distance : 0;
    /**
     * 衰减系数
     * @member {number}
     */

    _this.decay = props.decay !== undefined ? props.decay : 0;
    _this._lightColor = new o3Math.Vector3();
    return _this;
  }
  /** 获取点光源位置
...
var SpotLight = /*#__PURE__*/function (_Light) {
   ...
   */
  function SpotLight(entity, props) {
    var _this;
    ...
    _this.color = void 0;
    _this.penumbra = void 0;
    _this.distance = void 0;
    _this.intensity = void 0;
    _this.decay = void 0;
    _this.angle = void 0;
    _this.name = props.name || "spotLight";
    /**
     * 颜色
     * @member {Vector3}
     */
    ...
    _this.distance = props.distance || 0;
    /**
     * 衰减系数
     * @member {number}
     */

    _this.decay = props.decay || 0;
    /**
     * 半影衰减系数
     * @member {number}
     */

    _this.penumbra = props.penumbra || 0;
    /**
     * 散射角(弧度)
     * @member {number}
     */

    _this.angle = props.angle || Math.PI / 6;
    _this._lightColor = new o3Math.Vector3();
    _this._inverseDirection = new o3Math.Vector3();
    return _this;
  }
  /** 获取聚光灯位置
   * @return {Vector3} 位置坐标
  ...
  _createClass(SpotLight, [{
    ...
    key: "reverseDirection",
    get: function get() {
      o3Math.Vector3.scale(this.direction, -1, this._inverseDirection);
...
var AABB = /*#__PURE__*/function () {
   ...
   * */
  function AABB(minWorld, maxWorld) {
    _classCallCheck(this, AABB);

    this.min = new o3Math.Vector3();
    this.max = new o3Math.Vector3();
  ...
  _createClass(AABB, [{
    ...
    value: function setFromCenterAndSize(center, size) {
      var halfSize = new o3Math.Vector3();
      o3Math.Vector3.scale(size, 0.5, halfSize);
      o3Math.Vector3.subtract(center, halfSize, this.min);
      o3Math.Vector3.add(center, halfSize, this.max);
    }
    /**
     * 获取与视锥体的 具体相交状态
    ...
    value: function intersectsFrustum(frustumPlanes) {
      var min = this.min,
          max = this.max;
      var p1 = new o3Math.Vector3();
      var p2 = new o3Math.Vector3();
      ...
      for (var i = 0; i < 6; i++) {
        ...
        var d2 = pointDistanceToPlane(plane, p2); // 视锥体外

        if (d1 < 0 && d2 < 0) {
          return exports.IntersectInfo.EXCLUDE;
        } // 相交视锥体


        if (d1 < 0 || d2 < 0) {
          return exports.IntersectInfo.INTERSECT;
        }
      }

      return exports.IntersectInfo.INCLUDE;
    }
    /**
     * 是否在视锥体内部（包含或者交叉）
     * @param { Vector4[] } frustumPlanes -  Oasis 视锥体的6个平面方程
...
var OBB = /*#__PURE__*/function () {
  ...
  function OBB(minLocal, maxLocal, modelMatrix) {
    ...
    this.max = new o3Math.Vector3();
    this.corners = [];
    this.minWorld = new o3Math.Vector3();
    this.maxWorld = new o3Math.Vector3();
    this.cornersWorld = [];
    minLocal.cloneTo(this.min);
    maxLocal.cloneTo(this.max);
    this.corners = this.getCornersFromMinMax(minLocal, maxLocal); // world
  ...
  _createClass(OBB, [{
    ...
    value: function getCornersFromMinMax(min, max) {
      var minX = min.x,
          ...
          maxY = max.y,
          maxZ = max.z;
      var corners = [new o3Math.Vector3(minX, minY, minZ), new o3Math.Vector3(maxX, maxY, maxZ), new o3Math.Vector3(maxX, minY, minZ), new o3Math.Vector3(minX, maxY, minZ), new o3Math.Vector3(minX, minY, maxZ), new o3Math.Vector3(maxX, maxY, minZ), new o3Math.Vector3(minX, maxY, maxZ), new o3Math.Vector3(maxX, minY, maxZ)];
      return corners;
    }
    /**
    ...
    value: function updateByModelMatrix(modelMatrix) {
      ...
      for (var i = 0; i < 8; ++i) {
        ...
        o3Math.Vector3.transformCoordinate(corner, modelMatrix, cornerWorld);
        o3Math.Vector3.min(min, cornerWorld, min);
        o3Math.Vector3.max(max, cornerWorld, max);
        this.cornersWorld[i] = new o3Math.Vector3();
...
OBB._tempVec3 = new o3Math.Vector3();
...
var BoundingSphere = /*#__PURE__*/function () {
  ...
  function BoundingSphere(minLocal, maxLocal, modelMatrix) {
    ...
    this.center = new o3Math.Vector3();
    this.radius = 0;
    this.centerWorld = new o3Math.Vector3();
    this.radiusWorld = 0;
    // 先计算local
    var distance = o3Math.Vector3.distance(minLocal, maxLocal);
    this.radius = distance * 0.5;
    o3Math.Vector3.add(minLocal, maxLocal, this.center);
    this.center.scale(0.5); // 计算world
  ...
  _createClass(BoundingSphere, [{
    key: "updateByModelMatrix",
    value: function updateByModelMatrix(modelMatrix) {
      o3Math.Vector3.transformCoordinate(this.center, modelMatrix, this.centerWorld);
 ...
 * Mesh Asset Object
 */
var Mesh = /*#__PURE__*/function (_ReferenceObject) {
  _inherits(Mesh, _ReferenceObject);
...
var MeshRenderer = /*#__PURE__*/function (_RenderableComponent) {
  ...
  function MeshRenderer(entity) {
    ...
    _this = _super.call(this, entity, props);
    _this._mesh = void 0;
    _this._instanceMaterials = void 0;
    _this._sharedMaterials = void 0;
    _this._mesh = null; // Mesh Asset Object

    _this._instanceMaterials = []; // 这个组件独有的材质，用来单独控制材质参数

    _this._sharedMaterials = []; // Primitive默认材质，默认使用
  ...
  _createClass(MeshRenderer, [{
     ...
     * @param {Material} mtl 材质对象
     */
    value: function setMaterial(primitiveIndex, mtl) {
    ...
    value: function render(camera) {
      ...
      var primitives = mesh.primitives; //-- render every primitive

      for (var i = 0, len = primitives.length; i < len; i++) {
        var primitive = primitives[i];
        var mtl = this._instanceMaterials[i] || this._sharedMaterials[i];
    ...
    value: function destroy() {
      ...
      for (var _i = 0; _i < this._sharedMaterials.length; _i++) {
        this._sharedMaterials[_i]._addReference(-1);
      }
    ...
    value: function _updateBounds(worldBounds) {
      ...
      o3Math.Vector3.transformCoordinate(localBounds.min, worldMatrix, worldBounds.min); //TODO:简单模式，有漏洞，待AABB重构

      o3Math.Vector3.transformCoordinate(localBounds.max, worldMatrix, worldBounds.max);
    }
  }, {
    key: "mesh",
    get: function get() {
...
var Texture = /*#__PURE__*/function (_ReferenceObject) {
  _inherits(Texture, _ReferenceObject);
...
var Texture2D = /*#__PURE__*/function (_Texture) {
  ...
  function Texture2D(width, height) {
    ...
    var engine = arguments.length > 4 ? arguments[4] : undefined;
...
var SkinnedMeshRenderer = /*#__PURE__*/function (_MeshRenderer) {
  ...
  function SkinnedMeshRenderer(entity) {
    ...
    _this = _super.call(this, entity, props);
    _this._hasInitJoints = false;
    _this.matrixPalette = void 0;
    _this.jointNodes = void 0;
    _this.jointTexture = void 0;
    _this._mat = void 0;
    _this._weights = void 0;
    _this.weightsIndices = [];
    _this._skin = void 0;
    _this._useJointTexture = false;
    _this._mat = new o3Math.Matrix();
    _this._weights = null;
    _this._skin = null;
    _this.skin = props.skin;

    _this.setWeights((_props$mesh = props.mesh) === null || _props$mesh === void 0 ? void 0 : _props$mesh.weights);
  ...
  _createClass(SkinnedMeshRenderer, [{
    ...
    value: function update() {
      ...
      if (this._skin) {
        ...
        for (var i = joints.length - 1; i >= 0; i--) {
          ...
          if (joints[i]) {
            o3Math.Matrix.multiply(joints[i].transform.worldMatrix, ibms[i], mat);
          } else {
            ibms[i].cloneTo(mat);
          }

          o3Math.Matrix.multiply(worldToLocal, mat, mat);
    ...
    value: function createJointTexture() {
      if (!this.jointTexture) {
        var rhi = this.entity.engine._hardwareRenderer;
        if (!rhi) return;
        this.jointTexture = new Texture2D(4, this.jointNodes.length, exports.TextureFormat.R32G32B32A32, false);
...
var LODGroup = /*#__PURE__*/function (_RenderableComponent) {
   ...
   */
  function LODGroup(entity, props) {
    var _this;
  ...
  _createClass(LODGroup, [{
    ...
    value: function render(camera) {
      ...
      var dist = o3Math.Vector3.distance(camera.eyePos, this.entity.worldPosition);
      var lods = this._lods;
      var activeLevel = 0;
...
(function (VertexElementFormat) {
  VertexElementFormat[VertexElementFormat["Single"] = 0] = "Single";
...
var BufferUtil = /*#__PURE__*/function () {
  ...
  _createClass(BufferUtil, null, [{
    ...
    value: function _getElementInfo(format) {
      ...
      switch (format) {
        case exports.VertexElementFormat.Single:
          size = 1;
          type = exports.DataType.FLOAT;
          break;
 ...
 * @private
 */
var Primitive = /*#__PURE__*/function (_AssetObject) {
  _inherits(Primitive, _AssetObject);
  ...
  function Primitive(name) {
    ...
    _this = _super.call(this);
    _this.primitiveTopology = exports.PrimitiveTopology.Triangles;
    _this.drawOffset = 0;
    _this.drawCount = 0;
    ...
    _this._indexBufferBinding = void 0;
    _this._vertexElements = [];
    _this.id = void 0;
    _this.material = null;
    _this.materialIndex = void 0;
    _this.targets = [];
    _this.boundingBox = null;
    _this.boundingSphere = null;
    _this.isInFrustum = true;
    _this.id = Primitive._primitiveID++;
    _this.name = name;
    return _this;
  }
  /**
  ...
  _createClass(Primitive, [{
    ...
    value: function setVertexBufferBindings(bufferBindings) {
      ...
      var isArray = multiBindings.length !== undefined;
      ...
      if (isArray) {
        ...
        var singleBinding = bufferBindings;

        var _needLength = firstIndex + 1;

        bindings.length < _needLength && (bindings.length = _needLength);
    ...
    value: function setIndexBufferBinding(buffer, format) {
      var binding = this._indexBufferBinding;
    ...
    key: "addVertexElements",
    value: function addVertexElements(elements) {
      var isArray = elements.length !== undefined;

      if (isArray) {
        var addElements = elements;

        for (var i = 0, n = addElements.length; i < n; i++) {
          this._addVertexElement(addElements[i]);
        }
      } else {
        this._addVertexElement(elements);
      }
    }
  }, {
    key: "removeVertexElements",
    value: function removeVertexElements(vertexElements) {} // updateWeightsIndices(indices: number[]) {
    ...
    value: function destroy() {
      ...
      if (vertexBufferBindings) {
        for (var i = 0, n = vertexBufferBindings.length; i < n; i++) {
          var vertexBufferBinding = vertexBufferBindings[i];
      ...
      var indexBufferBinding = this._indexBufferBinding;
...
Primitive._primitiveID = 0;

/**
 * 材质对象：RenderTechniqe + 实例化参数，对应 glTF 中的 material 对象
 * @class
 */
var Material = /*#__PURE__*/function (_ReferenceObject) {
  _inherits(Material, _ReferenceObject);
  ...
  _createClass(Material, [{
        ...
        case exports.UniformSemantic.MODELVIEW:
          {
            ...
            if (!modelView) modelView = new o3Math.Matrix();
            o3Math.Matrix.multiply(view, model, modelView);
        ...
        case exports.UniformSemantic.MODELVIEWPROJECTION:
          {
            ...
            if (!MVP) MVP = new o3Math.Matrix();
            o3Math.Matrix.multiply(_viewProj, _model, MVP);
        ...
        case exports.UniformSemantic.MODELVIEWINVERSE:
          {
            ...
            if (!invMV) invMV = new o3Math.Matrix();
            o3Math.Matrix.multiply(_view, _model2, invMV);
            o3Math.Matrix.invert(invMV, invMV);
        ...
        case exports.UniformSemantic.MODELVIEWPROJECTIONINVERSE:
          {
            ...
            if (!invMVP) invMVP = new o3Math.Matrix();
            o3Math.Matrix.multiply(_viewProj2, _model3, invMVP);
            o3Math.Matrix.invert(invMVP, invMVP);
        ...
        case exports.UniformSemantic.MODELINVERSETRANSPOSE:
          {
            ...
            if (!modelIT) modelIT = new o3Math.Matrix3x3();
            o3Math.Matrix3x3.normalMatrix(component._entity.transform.worldMatrix, modelIT);
        ...
        case exports.UniformSemantic.MODELVIEWINVERSETRANSPOSE:
          {
            ...
            if (!modelViewIT) modelViewIT = new o3Math.Matrix();
            o3Math.Matrix.multiply(context.viewMatrix, component._entity.transform.worldMatrix, modelViewIT);
            o3Math.Matrix.invert(modelViewIT, modelViewIT);
            o3Math.Matrix.transpose(modelViewIT, modelViewIT);
    ...
    value: function onDestroy() {
      // TODO: 待材质重构
      var values = Object.values(this._values);
...
var IndexBuffer = /*#__PURE__*/function () {
  ...
  function IndexBuffer(engine, byteLengthOrData) {
    var bufferUsage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : exports.BufferUsage.Static;

    _classCallCheck(this, IndexBuffer);

    this._nativeBuffer = void 0;
    this._glBufferUsage = void 0;
    this._hardwareRenderer = void 0;
    this._engine = void 0;
    this._bufferUsage = void 0;
    this._byteLength = void 0;
    this._engine = engine;
  ...
  _createClass(IndexBuffer, [{
    ...
    value: function setData(data) {
      ...
      var dataByteLength = byteSize * dataLength;
    ...
    key: "resize",
    value: function resize(byteLength) {
      var gl = this._hardwareRenderer.gl;
      this.bind();
...
var VertexBuffer = /*#__PURE__*/function () {
  ...
  function VertexBuffer(engine, byteLengthOrData) {
    var bufferUsage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : exports.BufferUsage.Static;
  ...
  _createClass(VertexBuffer, [{
    ...
    value: function setData(data) {
      ...
      if (dataOffset !== 0 || dataByteLength < data.byteLength) {
        ...
        if (isWebGL2 && isArrayBufferView) {
          gl.bufferSubData(gl.ARRAY_BUFFER, bufferByteOffset, data, dataOffset, dataLength);
        } else {
          var subData = new Uint8Array(isArrayBufferView ? data.buffer : data, dataOffset * byteSize, dataByteLength);
...
var VertexElement = /*#__PURE__*/function () {
  ...
  function VertexElement(semantic, offset, format, vertexBufferIndex) {
    var instanceDivisor = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
    ...
    this._offset = void 0;
    this._format = void 0;
    this._vertexBufferIndex = void 0;
    this._instanceDivisor = void 0;
  ...
  _createClass(RenderTechnique, [{
    ...
    value: function getAttributeDefines(camera, component, primitive, material) {
      ...
      if (attribNames.indexOf("JOINTS_0") > -1) {
        ...
        if ((_component$jointNodes = component.jointNodes) === null || _component$jointNodes === void 0 ? void 0 : _component$jointNodes.length) {
...
var TextureCubeMap = /*#__PURE__*/function (_Texture) {
  ...
  function TextureCubeMap(size) {
    var _this;

    var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : exports.TextureFormat.R8G8B8A8;
    var mipmap = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
...
var RenderDepthTexture = /*#__PURE__*/function (_Texture) {
  ...
  function RenderDepthTexture(width, height) {
    var _this;

    var format = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : exports.RenderBufferDepthFormat.Depth;
    var mipmap = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var isCube = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var engine = arguments.length > 5 ? arguments[5] : undefined;
...
var RenderTarget = /*#__PURE__*/function (_AssetObject) {
  _inherits(RenderTarget, _AssetObject);
   ...
   * @internal
   */
  function RenderTarget(width, height, renderTexture) {
    var _this;

    var depth = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : exports.RenderBufferDepthFormat.Depth;
    var antiAliasing = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 1;
    var engine = arguments.length > 5 ? arguments[5] : undefined;
  ...
  _createClass(RenderTarget, [{
    ...
    value: function _setRenderTargetFace(faceIndex) {
      ...
      if (colorTexture === null || colorTexture === void 0 ? void 0 : colorTexture._isCube) {
      ...
      if (depthTexture === null || depthTexture === void 0 ? void 0 : depthTexture._isCube) {
...
var RenderColorTexture = /*#__PURE__*/function (_Texture) {
  ...
  function RenderColorTexture(width, height) {
    var _this;

    var format = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : exports.RenderBufferColorFormat.R8G8B8A8;
    var mipmap = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var isCube = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var engine = arguments.length > 5 ? arguments[5] : undefined;
...
var SpriteRenderer = /*#__PURE__*/function (_RenderableComponent) {
   ...
   * @param {Sprite} sprite
   */
  function SpriteRenderer(entity, sprite) {
    var _this;
    ...
    _this._rotationAngle = void 0;
    _this._anchor = void 0;
    _this._texture = void 0;
    _this._rect = void 0;
    _this._worldSizeFactor = void 0;
    _this.renderMode = "2D";
    _this.tintColor = new o3Math.Vector4(1, 1, 1, 1);
    _this.transformMatrix = void 0;
    var texture = sprite.texture,
        rect = sprite.rect,
        anchor = sprite.anchor,
        worldSizeFactor = sprite.worldSizeFactor;
    _this._worldSizeFactor = worldSizeFactor || 100;
    ...
    if (sprite.tintColor) {
      _this.tintColor = sprite.tintColor;
    } // //-- Ability属性
    ...
    _this._positionQuad = {
      leftTop: new o3Math.Vector3(),
      leftBottom: new o3Math.Vector3(),
      rightTop: new o3Math.Vector3(),
      rightBottom: new o3Math.Vector3()
    };
  ...
  _createClass(SpriteRenderer, [{
    ...
    value: function _transformByMatrix() {
      ...
      o3Math.Vector4.transform(leftTop, matrix, leftTop);
      o3Math.Vector4.transform(leftBottom, matrix, leftBottom);
      o3Math.Vector4.transform(rightTop, matrix, rightTop);
      o3Math.Vector4.transform(rightBottom, matrix, rightBottom);
    ...
    value: function _updatePositionQuad(camera) {
      if (this.renderMode === "2D") {
        ...
        var vx = new o3Math.Vector3(m[0], m[4], m[8]);
        var vy = new o3Math.Vector3(m[1], m[5], m[9]); //-- center pos
        ...
        if (this._rotationAngle !== 0) {
          var vz = new o3Math.Vector3(m[2], m[6], m[10]);
          var rotation = new o3Math.Quaternion();
          o3Math.Quaternion.rotationAxisAngle(vz, this._rotationAngle, rotation);
          o3Math.Vector3.transformByQuat(vx, rotation, vx);
          o3Math.Vector3.transformByQuat(vy, rotation, vy);
        }

        var cx = new o3Math.Vector3();
        var cy = new o3Math.Vector3();
        o3Math.Vector3.scale(vx, (this.anchor[0] - 0.5) * 2, cx);
        o3Math.Vector3.scale(vy, (this.anchor[1] - 0.5) * 2, cy);
        c.subtract(cx).add(cy); //-- quad pos

        var leftTop = this._positionQuad.leftTop;
        o3Math.Vector3.subtract(c, vx, leftTop);
        leftTop.add(vy);
        var leftBottom = this._positionQuad.leftBottom;
        o3Math.Vector3.subtract(c, vx, leftBottom);
        leftBottom.subtract(vy);
        var rightBottom = this._positionQuad.rightBottom;
        o3Math.Vector3.add(c, vx, rightBottom);
        rightBottom.subtract(vy);
        var rightTop = this._positionQuad.rightTop;
        o3Math.Vector3.add(c, vx, rightTop);
        rightTop.add(vy);
      }
    }
  }, {
...
SpriteRenderer._tempVec40 = new o3Math.Vector4();
SpriteRenderer._tempVec41 = new o3Math.Vector4();
SpriteRenderer._tempVec42 = new o3Math.Vector4();
SpriteRenderer._tempVec43 = new o3Math.Vector4();
...
(function (AnimationEvent) {
  AnimationEvent[AnimationEvent["FINISHED"] = 0] = "FINISHED";
  AnimationEvent[AnimationEvent["LOOP_END"] = 1] = "LOOP_END";
  AnimationEvent[AnimationEvent["FRAME_EVENT"] = 2] = "FRAME_EVENT";
...
var Animation = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Animation, [{
    ...
    value: function lerp(outValue, startValue, endValue, alpha, outputSize) {
      switch (outputSize) {
        ...
        case 4:
          var start = _construct(o3Math.Quaternion, _toConsumableArray(startValue));

          var end = _construct(o3Math.Quaternion, _toConsumableArray(endValue));

          var quat = new o3Math.Quaternion();
          o3Math.Quaternion.slerp(start, end, alpha, quat);
          outValue[0] = quat.x;
          outValue[1] = quat.y;
          outValue[2] = quat.z;
          outValue[3] = quat.w;
  ...
  function Animation(entity) {
    ...
    _this = _super.call(this, entity);
    _this._onUpdateIndex = -1;
    _this._animSet = void 0;
    _this._animLayers = void 0;
    _this._timeScale = void 0;
    _this._channelTargets = void 0;
    _this._animSet = {}; // name : AnimationClip

    _this._animLayers = [new AnimationLayer()];
  ...
  _createClass(Animation, [{
    ...
    key: "_cloneTo",
    value: function _cloneTo(destComponent) {
      for (var aniClip in this._animSet) {
        destComponent._animSet[aniClip] = this._animSet[aniClip];
      }
    }
  }]);
...
var CommonMaterial = /*#__PURE__*/function (_Material) {
  ...
  function CommonMaterial(name) {
    ...
    _this.emission = new o3Math.Vector4(0, 0, 0, 1);
    _this.ambient = new o3Math.Vector4(0, 0, 0, 1);
    /**
     * Technique 渲染状态控制
     * @member {object}
     */
...
var LambertMaterial = /*#__PURE__*/function (_CommonMaterial) {
  ...
  function LambertMaterial(name) {
    ...
    _this.diffuse = new o3Math.Vector4(1, 1, 1, 1);
    return _this;
  }
  /**
   * 环境光反射颜色
...
var BlinnPhongMaterial = /*#__PURE__*/function (_CommonMaterial) {
   ...
   * @param {String} name 名称
   */
  function BlinnPhongMaterial(name) {
    var _this;
    ...
    _this.diffuse = new o3Math.Vector4(1, 1, 1, 1);
    _this.specular = new o3Math.Vector4(1, 1, 1, 1);
...
var TextureMaterial = /*#__PURE__*/function (_CommonMaterial) {
   ...
   * @param {string} name 名称
   */
  function TextureMaterial(name) {
    _classCallCheck(this, TextureMaterial);

    return _super.call(this, name || "TextureMaterial");
  }
...
TextureMaterial.DISABLE_SHARE = true;
...
var TransparentMaterial = /*#__PURE__*/function (_CommonMaterial) {
  ...
  function TransparentMaterial(name) {
    ...
    return _super.call(this, name || "TransparentMaterial");
  }
...
TransparentMaterial.DISABLE_SHARE = true;
 ...
 * 绘制组，描述了绘制范围。
 */
var DrawGroup = function DrawGroup() {
  _classCallCheck(this, DrawGroup);
 ...
 * 缓冲几何体。
 */
var BufferGeometry = /*#__PURE__*/function (_AssetObject) {
  _inherits(BufferGeometry, _AssetObject);
  ...
  function BufferGeometry(name) {
    ...
    _this._primitive = new Primitive();

    _this._drawGroups.push(new DrawGroup());
  ...
  _createClass(BufferGeometry, [{
    ...
    key: "addDrawGroup",
    value: function addDrawGroup(offset, count) {
      var drawGroup = new DrawGroup();
    ...
    key: "removeDrawGroup",
    value: function removeDrawGroup(drawGroup) {
      var drawGroups = this._drawGroups;
      var index = drawGroups.indexOf(drawGroup);
...
BufferGeometry._geometryCount = 0;
...
var GeometryRenderer = /*#__PURE__*/function (_RenderableComponent) {
   ...
   * @param props
   */
  function GeometryRenderer(entity) {
    var _this;
    ...
    _this._geometry = props.geometry;
  ...
  _createClass(GeometryRenderer, [{
     ...
     * @param {Material} mtl 材质对象
     */
    value: function setMaterial(mtl) {
      this._material = mtl;
    }
  }, {
    key: "getMaterial",
    ...
    value: function render(camera) {
      ...
      var primitive = geometry._primitive;

      if (primitive && this._material) {
        var drawGroup = geometry.drawGroups[0];
    ...
    key: "destroy",
    value: function destroy() {
      _get(_getPrototypeOf(GeometryRenderer.prototype), "destroy", this).call(this); //-- release mesh


      this._geometry = null; //-- materials
...
var GeometryShape = /*#__PURE__*/function (_BufferGeometry) {
  _inherits(GeometryShape, _BufferGeometry);

  var _super = _createSuper(GeometryShape);

  function GeometryShape() {
    _classCallCheck(this, GeometryShape);

    return _super.apply(this, arguments);
  }

  _createClass(GeometryShape, [{
    key: "_initialize",
    ...
    value: function _initBuffer(engine, vertices, indices, vertexStride, vertexElements) {
      var vertexBuffer = new VertexBuffer(engine, vertices, exports.BufferUsage.Static);
      var indexBuffer = new IndexBuffer(engine, indices, exports.BufferUsage.Static);
    ...
    key: "_computeBounds",
    value: function _computeBounds(vertices) {
      var vertexElement = this._primitive._vertexElementMap["POSITION"];
      var bufferIndex = vertexElement.vertexBufferIndex;
      ...
      var min = new o3Math.Vector3(Infinity, Infinity, Infinity);
      var max = new o3Math.Vector3(-Infinity, -Infinity, -Infinity);

      for (var i = 0; i < vertexCount; i++) {
        var base = offset + stride * i;
        var position = new o3Math.Vector3(dataView.getFloat32(base, true), dataView.getFloat32(base + 4, true), dataView.getFloat32(base + 8, true));
        o3Math.Vector3.min(min, position, min);
        o3Math.Vector3.max(max, position, max);
      }
 ...
 * 长方体
 */
var CuboidGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(CuboidGeometry, _GeometryShape);
...
var SphereGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(SphereGeometry, _GeometryShape);
   ...
   */
  function SphereGeometry(radius, horizontalSegments, verticalSegments, alphaStart, alphaRange, thetaStart, thetaRange, engine) {
    var _this;
...
var PlaneGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(PlaneGeometry, _GeometryShape);
   ...
   * @param {number} verticalSegments 垂直分段数
   */
  function PlaneGeometry(width, height, horizontalSegments, verticalSegments, engine) {
    var _this;
 ...
 * @extends BufferGeometry
 */
var CylinderGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(CylinderGeometry, _GeometryShape);
   ...
   */
  function CylinderGeometry(radiusTop, radiusBottom, height, radialSegments, heightSegments, openEnded, thetaStart, thetaLength, frontFace, engine) {
    var _this;
    ...
    _this.FrontFace = frontFace || exports.FrontFace.CCW;
    _this._parameters = {
...
var CircleGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(CircleGeometry, _GeometryShape);
...
var ScreenQuadGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(ScreenQuadGeometry, _GeometryShape);
  ...
  function ScreenQuadGeometry(engine) {
    ...
    _this = _super.call(this);
    _this.primitiveTopology = exports.PrimitiveTopology.TriangleFan;
    var vertices = new Float32Array([-1, -1, 0, 0, 0, 1, -1, 0, 1, 0, 1, 1, 0, 1, 1, -1, 1, 0, 0, 1]);
    var indices = new Uint16Array([0, 1, 2, 3]);

    _this._initialize(engine, vertices, indices);

    _this._primitive.drawCount = indices.length; //TODO:临时添加,待底层结构调整删除
...
var TorusGeometry = /*#__PURE__*/function (_GeometryShape) {
  _inherits(TorusGeometry, _GeometryShape);
...
var Model = /*#__PURE__*/function (_GeometryRenderer) {
    ...
    set: function set(value) {
      ...
      switch (value) {
        case "Sphere":
          ...
          this.geometry = new SphereGeometry(sphereRadius, sphereHorizontalSegments, sphereVerticalSegments, sphereAlphaStart, sphereAlphaRange, sphereThetaStart, sphereThetaRange, this.engine);
          break;
        ...
        case "Cylinder":
          ...
          this.geometry = new CylinderGeometry(cylinderRadiusTop, cylinderRadiusBottom, cylinderHeight, cylinderRadialSegments, cylinderHeightSegments, cylinderOpenEnded, undefined, undefined, undefined, this.engine);
          break;
        ...
        case "Plane":
          ...
          this.geometry = new PlaneGeometry(planeWidth, planeHeight, planeHorizontalSegments, planeVerticalSegments, this.engine);
          break;
  ...
  function Model(entity, props) {
    ...
    if (!props.material) {
      _this._material = new BlinnPhongMaterial("mtl");
    }
...
var SkyBoxMaterial = /*#__PURE__*/function (_Material) {
  ...
  function SkyBoxMaterial() {
    ...
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : SkyBoxMaterial.defaultName;
  ...
  _createClass(SkyBoxMaterial, [{
    ...
    value: function prepareDrawing(context, component) {
      ...
      if (!this._cacheMat1) {
        this._cacheMat1 = new o3Math.Matrix();
        this._cacheMat2 = new o3Math.Matrix();
      }

      var view = context.viewMatrix;
      var proj = context.projectionMatrix;
      o3Math.Matrix.multiply(view, this.modelMatrix, this._cacheMat1);
      var e = this._cacheMat1.elements;
      e[12] = e[13] = e[14] = 0;
      o3Math.Matrix.multiply(proj, this._cacheMat1, this._cacheMat2);
...
var SkyBox = /*#__PURE__*/function (_GeometryRenderer) {
  ...
  function SkyBox(entity, props) {
    ...
    var skyBoxMap = props.skyBoxMap;
    /**
     * 天空盒纹理
     * @member {TextureCubeMap}
     */

    _this.geometry = new CuboidGeometry(2, 2, 2, _this.engine);
    _this.material = new SkyBoxMaterial();
    _this.skyBoxMap = skyBoxMap;
    return _this;
  }
...
var PBRMaterial = /*#__PURE__*/function (_Material) {
  ...
  function PBRMaterial() {
    ...
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : PBRMaterial.MATERIAL_NAME;
    var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _createClass(PBRMaterial, [{
    ...
    value: function createDefaulteValues() {
      ...
      this._uniformObj = {
        baseColorFactor: new o3Math.Vector4(1.0, 1.0, 1.0, 1.0),
        metallicFactor: 1,
        roughnessFactor: 1,
        metallicRoughness: new o3Math.Vector2(1.0, 1.0),
        normalScale: 1,
        emissiveFactor: new o3Math.Vector3(0.0, 0.0, 0.0),
        occlusionStrength: 1,
        alphaCutoff: 0.5,
        // specular-glossiness workflow
        specularFactor: new o3Math.Vector3(1.0, 1.0, 1.0),
        glossinessFactor: 0,
        // reflect,refract
        envMapIntensity: 1,
    ...
    value: function prepareDrawing(context, component, primitive) {
      ...
      this.setValue("u_resolution", new o3Math.Vector2(canvas.width, canvas.height));
      /** clipPlane */
    ...
    value: function _generateShaderMacros(camera, component, primitive) {
      ...
      if (uniforms.indexOf("u_refractionSampler") > -1) {
        this.setValueByParamName("PTMMatrix", new o3Math.Matrix(0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.5, 0.5, 0.5, 1.0));
    ...
    value: function clone(name) {
      var newMtl = new PBRMaterial(name || this.name);
      newMtl.renderType = this.renderType;
      newMtl.useFog = this.useFog;
...
var GPUParticleSystem = /*#__PURE__*/function (_GeometryRenderer) {
  ...
  _createClass(GPUParticleSystem, [{
    ...
    value: function setMaterial() {
      ...
      var material = new Material("particleMaterial", this.engine);
      ...
      _get(_getPrototypeOf(GPUParticleSystem.prototype), "setMaterial", this).call(this, material);
    ...
    value: function _createGeometry() {
      var geometry = new BufferGeometry("particleGeometry");
      geometry.primitiveTopology = exports.PrimitiveTopology.Triangles;
      var vertexStride = 96;
      ...
      var vertexElements = [new VertexElement("POSITIONSTART", 0, exports.VertexElementFormat.Vector3, 0), new VertexElement("VELOCITY", 12, exports.VertexElementFormat.Vector3, 0), new VertexElement("ACCELERATION", 24, exports.VertexElementFormat.Vector3, 0), new VertexElement("COLOR", 36, exports.VertexElementFormat.Vector3, 0), new VertexElement("ALPHA", 48, exports.VertexElementFormat.Single, 0), new VertexElement("SIZE", 52, exports.VertexElementFormat.Single, 0), new VertexElement("ROTATERATE", 56, exports.VertexElementFormat.Single, 0), new VertexElement("STARTTIME", 60, exports.VertexElementFormat.Single, 0), new VertexElement("LIFETIME", 64, exports.VertexElementFormat.Single, 0), new VertexElement("STARTANGLE", 68, exports.VertexElementFormat.Single, 0), new VertexElement("SCALEFACTOR", 72, exports.VertexElementFormat.Single, 0), new VertexElement("UV", 76, exports.VertexElementFormat.Vector3, 0), new VertexElement("NORMALIZED_UV", 88, exports.VertexElementFormat.Vector2, 0)];
      var vertexBuffer = new VertexBuffer(this.engine, vertexFloatCount * 4, exports.BufferUsage.Dynamic);
      var indexBuffer = new IndexBuffer(this.engine, indices, exports.BufferUsage.Dynamic);
    ...
    value: function _spawnParticle(options, i) {
      var position = options.position !== undefined ? options.position.clone() : new o3Math.Vector3();
      var positionRandomness = options.positionRandomness !== undefined ? options.positionRandomness.clone() : new o3Math.Vector3();
      var positionArray = options.positionArray;
      var velocity = options.velocity !== undefined ? options.velocity.clone() : new o3Math.Vector3();
      var velocityRandomness = options.velocityRandomness !== undefined ? options.velocityRandomness.clone() : new o3Math.Vector3();
      var color = options.color !== undefined ? options.color.clone() : new o3Math.Vector3(1, 1, 1);
      ...
      var acceleration = options.acceleration !== undefined ? options.acceleration.clone() : new o3Math.Vector3();
      var accelerationRandomness = options.accelerationRandomness !== undefined ? options.accelerationRandomness.clone() : new o3Math.Vector3();
      ...
      color.x = o3Math.MathUtil.clamp(color.x + this._getRandom() * colorRandomness, 0, 1);
      color.y = o3Math.MathUtil.clamp(color.y + this._getRandom() * colorRandomness, 0, 1);
      color.z = o3Math.MathUtil.clamp(color.z + this._getRandom() * colorRandomness, 0, 1);
      ...
      var particleAlpha = o3Math.MathUtil.clamp(alpha + this._getRandom() * alphaRandomness, 0, 1);
...
var Particle = /*#__PURE__*/function (_GPUParticleSystem) {
  ...
  function Particle(node, props) {
    ...
    if (props.__separate) {
      _this._config.blendFuncSeparate = [exports.BlendFunc[props.__srcRGB || "SRC_ALPHA"], exports.BlendFunc[props.__dstRGB || "ONE_MINUS_SRC_ALPHA"], exports.BlendFunc[props.__srcAlpha || "SRC_ALPHA"], exports.BlendFunc[props.__dstAlpha || "ONE_MINUS_SRC_ALPHA"]];
    } else if (props.__src && props.__dst) {
      _this._config.blendFunc = [exports.BlendFunc[props.__src], exports.BlendFunc[props.__dst]];
    }

    _this.initialize(_this._config);
...
var _tempVector3 = new o3Math.Vector3();
/**
 * 拖尾效果渲染组件
 */
...
var TrailRenderer = /*#__PURE__*/function (_GeometryRenderer) {
  ...
  function TrailRenderer(entity, props) {
    ...
    for (var i = 0; i < _this._maxPointNum; i++) {
      _this._points.push(new o3Math.Vector3());

      _this._pointStates.push(_this._lifetime);

      _this._strapPoints.push(new o3Math.Vector3());

      _this._strapPoints.push(new o3Math.Vector3());
    }

    _this._curPointNum = 0;
    var mtl = props.material || new TrailMaterial("trial_mtl");
  ...
  _createClass(TrailRenderer, [{
    ...
    value: function update(deltaTime) {
      ...
      if (this._curPointNum === this._maxPointNum) {
        ...
        if (o3Math.Vector3.distance(this.entity.worldPosition, lastPoint) < this._minSeg) {
          appendNewPoint = false;
        }
      }
    ...
    value: function _initGeometry() {
      ...
      geometry.primitiveTopology = exports.PrimitiveTopology.TriangleStrip;
      var vertexStride = 20;
    ...
    value: function _updateStrapVertices(camera, points) {
      ...
      var e = m.elements;
      var vx = new o3Math.Vector3(e[0], e[4], e[8]);
      var vy = new o3Math.Vector3(e[1], e[5], e[9]);
      var vz = new o3Math.Vector3(e[2], e[6], e[10]);
      var s = this._stroke;
      vy.scale(s);
      var up = new o3Math.Vector3();
      var down = new o3Math.Vector3();
      var rotation = new o3Math.Quaternion();
      o3Math.Vector3.transformByQuat(vx, rotation, vx);
      o3Math.Vector3.transformByQuat(vy, rotation, vy);
      var dy = new o3Math.Vector3();
      var cross = new o3Math.Vector3();
      var perpVector = new o3Math.Vector3();
      vx.normalize();
      ...
      for (var i = 0; i < this._maxPointNum; i++) {
        ...
        if (i < this._curPointNum) {
          ...
          if (i === this._curPointNum - 1 && i !== 0) {
            o3Math.Vector3.subtract(p, points[i - 1], perpVector);
          } else {
            o3Math.Vector3.subtract(points[i + 1], p, perpVector);
          }
          ...
          var angle = Math.acos(o3Math.Vector3.dot(vx, perpVector));
          o3Math.Vector3.cross(vx, perpVector, cross);

          if (o3Math.Vector3.dot(cross, vz) <= 0) {
            angle = Math.PI * 2 - angle;
          }

          o3Math.Quaternion.rotationAxisAngle(vz, angle, rotation);
          o3Math.Vector3.transformByQuat(vy, rotation, dy);
          o3Math.Vector3.add(p, dy, up);
          o3Math.Vector3.subtract(p, dy, down);
        }
    ...
    value: function _projectOnVector(a, p, out) {
      var n_p = p.clone();
      o3Math.Vector3.normalize(n_p, n_p);
      var cosine = o3Math.Vector3.dot(a, n_p);
      out.x = n_p.x * cosine;
      out.y = n_p.y * cosine;
      out.z = n_p.z * cosine;
    }
    ...
    value: function _projectOnPlane(a, n, out) {
      ...
      o3Math.Vector3.subtract(a, _tempVector3, out);
    }
  }]);
...
var Ray = /*#__PURE__*/function () {
  ...
  function Ray(origin, direction) {
    ...
    this.origin = void 0;
    this.origin = origin;
    this.direction = new o3Math.Vector3();
    o3Math.Vector3.normalize(direction, this.direction);
  }
  /**
   * 检测本射线与平面相交
  ...
  _createClass(Ray, [{
    ...
    value: function intersectPlane(point, normal) {
      ...
      var denom = o3Math.Vector3.dot(normal, this.direction);

      if (Math.abs(denom) > 1e-6) {
        var p0l0 = new o3Math.Vector3();
        o3Math.Vector3.subtract(point, origin, p0l0);
        var t = o3Math.Vector3.dot(p0l0, normal) / denom;
    ...
    value: function getPoint(distance) {
      ...
      var point = new o3Math.Vector3();
      o3Math.Vector3.scale(this.direction, distance, point);
    ...
    value: function intersectSphere(center, radius) {
      ...
      var L = new o3Math.Vector3();
      o3Math.Vector3.subtract(this.origin, center, L);
      var a = o3Math.Vector3.dot(dir, dir);
      var b = 2 * o3Math.Vector3.dot(dir, L);
      var c = o3Math.Vector3.dot(L, L) - radius * radius;

      var s = _solveQuadratic(a, b, c);
    ...
    value: function intersectAABB(max, min) {
      ...
      var invdir = new o3Math.Vector3(1 / dir.x, 1 / dir.y, 1 / dir.z);
      var bounds = [min, max];
...
var Collider = /*#__PURE__*/function (_Component) {
   ...
   * @param {Entity} entity
   */
  function Collider(entity, props) {
    var _this;
    ...
    _this = _super.call(this, entity, props);
    _this.tag = void 0;
    _this.tag = props.tag || exports.MaskList.EVERYTHING;
    return _this;
  }
...
var _tempVec30 = new o3Math.Vector3();

var _tempVec31 = new o3Math.Vector3();

var _tempVec32 = new o3Math.Vector3();

var _tempVec33 = new o3Math.Vector3();

var _tempVec34 = new o3Math.Vector3();

var _tempVec35 = new o3Math.Vector3();

var _tempVec36 = new o3Math.Vector3();

var _tempVec37 = new o3Math.Vector3();
/**
...
var ABoxCollider = /*#__PURE__*/function (_Collider) {
   ...
   * @param {Entity} entity 对象所在节点
   */
  function ABoxCollider(entity, props) {
    var _this;
    ...
    _this.boxMax = void 0;
    _this._corners = [];
    _this.boxMin = new o3Math.Vector3(-0.5, -0.5, -0.5);
    _this.boxMax = new o3Math.Vector3(0.5, 0.5, 0.5);
    return _this;
  }
  /**
   * 使用范围坐标，设置包围盒
  ...
  _createClass(ABoxCollider, [{
    ...
    value: function setBoxCenterSize(center, size) {
      ...
      o3Math.Vector3.scale(size, 0.5, halfSize);
      o3Math.Vector3.add(center, halfSize, this.boxMax);
      o3Math.Vector3.subtract(center, halfSize, this.boxMin);
      this._corners.length = 0;
    }
    /**
     * 取得八个顶点的位置
    ...
    value: function getCorners() {
      if (this._corners.length === 0) {
        ...
        var d = this.boxMax.z - minZ; // follow the same order as the old
...
ABoxCollider._tempVec3 = new o3Math.Vector3();
...
var ASphereCollider = /*#__PURE__*/function (_Collider) {
   ...
   * @param {Entity} entity
   */
  function ASphereCollider(entity, props) {
    var _this;
    ...
    _this.center = void 0;
    _this.radius = void 0;
    _this.center = new o3Math.Vector3();
    /**
     * 球体的半径
     * @member {float}
     */
...
var PlaneCollider = /*#__PURE__*/function (_Collider) {
   ...
   * @param {Entity} entity
   */
  function PlaneCollider(entity, props) {
    var _this;
    ...
    _this.normal = void 0;
    _this.planePoint = new o3Math.Vector3();
    /**
     * 平面法线的方向
     * @member {Vector3}
     */

    _this.normal = new o3Math.Vector3(0, 1, 0);
    return _this;
  }
  /**
   * 使用Local坐标，设置point
...
function _updateHitResult(collider, ray, distance, outHit, origin) {
  ...
  o3Math.Vector3.transformCoordinate(hitPos, collider.entity.transform.worldMatrix, hitPos);
  outHit.distance = o3Math.Vector3.distance(origin, hitPos);
...
function _getLocalRay(collider, ray) {
  ...
  var o = new o3Math.Vector3();
  o3Math.Vector3.transformCoordinate(ray.origin, worldToLocal, o); // d = worldToLocal * vec4(ray.direction, 0)

  var d = new o3Math.Vector3();
...
var BoxCollider = /*#__PURE__*/function (_ABoxCollider) {
  ...
  function BoxCollider(entity, props) {
    var _this;

    _classCallCheck(this, BoxCollider);

    _this = _super.call(this, entity, props);
    _this._center = new o3Math.Vector3();
    _this._size = new o3Math.Vector3();
    _this.isShowCollider = true;
    var center = props.center,
        size = props.size,
        isShowCollider = props.isShowCollider;
    _this.center = center !== null && center !== void 0 ? center : _this.center;
    _this.size = size !== null && size !== void 0 ? size : _this.size;
    _this.isShowCollider = isShowCollider !== null && isShowCollider !== void 0 ? isShowCollider : _this.isShowCollider;
    return _this;
  }
...
var SphereCollider = /*#__PURE__*/function (_ASphereCollider) {
  ...
  function SphereCollider(entity, props) {
    var _this;

    _classCallCheck(this, SphereCollider);

    _this = _super.call(this, entity, props);
    _this.__center = new o3Math.Vector3();
    _this.__radius = 1.0;
    _this.isShowCollider = true;
    var _center = props._center,
        _radius = props._radius,
        isShowCollider = props.isShowCollider;
    _this._center = _center !== null && _center !== void 0 ? _center : _this._center;
    _this._radius = _radius !== null && _radius !== void 0 ? _radius : _this._radius;
    _this.isShowCollider = isShowCollider !== null && isShowCollider !== void 0 ? isShowCollider : _this.isShowCollider;
    return _this;
  }
...
function intersectSphere2Sphere(sphereA, sphereB) {
  var distance = o3Math.Vector3.distance(sphereA.center, sphereB.center);
...
function intersectSphere2Box(sphere, box) {
  ...
  var closestPoint = new o3Math.Vector3(Math.max(box.min.x, Math.min(center.x, box.max.x)), Math.max(box.min.y, Math.min(center.y, box.max.y)), Math.max(box.min.z, Math.min(center.z, box.max.z)));
  var distance = o3Math.Vector3.distance(center, closestPoint);
...
var CollisionDetection = /*#__PURE__*/function (_Script) {
  ...
  _createClass(CollisionDetection, [{
    ...
    value: function _getWorldBox(boxCollider) {
      ...
      var max = new o3Math.Vector3();
      var min = new o3Math.Vector3();
      o3Math.Vector3.transformCoordinate(boxCollider.boxMax, mat, max);
      o3Math.Vector3.transformCoordinate(boxCollider.boxMin, mat, min); //--

      var temp = CollisionDetection._tempVec3;
      var corners = boxCollider.getCorners();

      for (var i = 0; i < 8; i++) {
        o3Math.Vector3.transformCoordinate(corners[i], mat, temp);
    ...
    value: function _getWorldSphere(sphereCollider) {
      var center = new o3Math.Vector3();
      o3Math.Vector3.transformCoordinate(sphereCollider.center, sphereCollider.entity.transform.worldMatrix, center);
      return {
...
CollisionDetection._tempVec3 = new o3Math.Vector3();
...
var Fog = /*#__PURE__*/function (_Component) {
  ...
  function Fog(node, props) {
    var _this;

    _classCallCheck(this, Fog);

    _this = _super.call(this, node, props);
    /**
     * 雾颜色
     * @member {Vector3}
     */
    ...
    _this.color = void 0;
    _this.color = props.color === undefined ? new o3Math.Vector3(1, 0, 0) : props.color;
    return _this;
  }
  /**
   * @private
...
var EXP2Fog = /*#__PURE__*/function (_Fog) {
  ...
  function EXP2Fog(node, props) {
    ...
    _this.density = void 0;
    _this.density = props.density === undefined ? 0.0025 : props.density;
    return _this;
  }
  /**
   * @private
...
var LinearFog = /*#__PURE__*/function (_Fog) {
  ...
  function LinearFog(node, props) {
    ...
    _this.far = void 0;
    _this.color = void 0;
    _this.near = props.near === undefined ? 1 : props.near;
    /**
     * 最远距离
     * @member {Number}
     */

    _this.far = props.far === undefined ? 1000 : props.far;
    return _this;
  }
  /**
   * @private
...
var Probe = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Probe, [{
    ...
    get: function get() {
      ...
      return opaqueQueue.items.concat(transparentQueue.items).filter(function (item) {
        ...
        if (_this2.excludeRenderList.includes(item.mtl)) return false;
        if (_this2.renderAll) return true;
        if (_this2.renderList.includes(item.mtl)) return true;
      });
    }
  ...
  function Probe(entity) {
    ...
    _this = _super.call(this, entity, config);
    _this.cacheId = void 0;
    _this.isCube = void 0;
    ...
    _this.isCube = !!config.isCube;
    _this.camera = config.camera || _this.scene._activeCameras[0];
    _this.excludeRenderList = config.excludeRenderList || [];
    _this.renderAll = !!config.renderAll;
    _this.renderList = config.renderList || [];
    _this.clipPlanes = config.clipPlanes || [];
    var width = config.width || 1024;
    var height = config.height || 1024;
    var samples = config.samples || 1;
    _this.renderTarget = new RenderTarget(width, height, new RenderColorTexture(width, height, undefined, false, _this.isCube, _this.engine), exports.RenderBufferDepthFormat.Depth, samples, _this.engine);
    _this.renderTargetSwap = new RenderTarget(width, height, new RenderColorTexture(width, height, undefined, false, _this.isCube, _this.engine), exports.RenderBufferDepthFormat.Depth, samples, _this.engine);
    _this.renderPass.renderTarget = _this.renderTarget;
    /**
     * 继续 RTT
     * */
  ...
  _createClass(Probe, [{
    ...
    value: function render() {
      ...
      this.renderItems.forEach(function (item) {
        ...
        _this3.rhi.drawPrimitive(primitive, mtl);
      });
    }
  }, {
    key: "postRender",
...
var PlaneProbe = /*#__PURE__*/function (_Probe) {
  ...
  function PlaneProbe(node) {
    ...
    return _super.call(this, node, config);
  }
  /**
   * 预处理材质，保存初始状态
   * */
...
var cacheTarget = new o3Math.Vector3();
var cacheUp = new o3Math.Vector3();
var cacheDir = new o3Math.Vector3();
...
var CubeProbe = /*#__PURE__*/function (_Probe) {
  ...
  function CubeProbe(node) {
    ...
    _this = _super.call(this, node, _objectSpread2(_objectSpread2({}, config), {}, {
      isCube: true
    }));
    _this.position = void 0;
    _this.oriViewMatrix = new o3Math.Matrix();
    _this.oriInverseViewMatrix = new o3Math.Matrix();
    _this.oriProjectionMatrix = new o3Math.Matrix();
    _this.oriInverseProjectionMatrix = new o3Math.Matrix();
    _this.position = config.position || new o3Math.Vector3();
    return _this;
  }
  /**
   * 贮藏原相机参数
  ...
  _createClass(CubeProbe, [{
    ...
    value: function setCamera(faceIndex) {
      ...
      o3Math.Vector3.add(this.position, cacheDir, cacheTarget);
      o3Math.Matrix.lookAt(this.position, cacheTarget, cacheUp, this.camera.viewMatrix);
      o3Math.Matrix.invert(this.camera.viewMatrix, this.camera.inverseViewMatrix);
      o3Math.Matrix.perspective(fovRadian, 1, this.camera.nearClipPlane, this.camera.farClipPlane, this.camera.projectionMatrix);
      o3Math.Matrix.invert(this.camera.projectionMatrix, this.camera.inverseProjectionMatrix);
    }
  }]);
...
var LightShadow = /*#__PURE__*/function () {
  function LightShadow() {
    ...
    this.radius = void 0;
    this.projectionMatrix = void 0;
    this._mapSize = new o3Math.Vector2(props.width, props.height);
    ...
    this.projectionMatrix = new o3Math.Matrix();
  }
  /**
  ...
  _createClass(LightShadow, [{
    ...
    value: function initShadowProjectionMatrix(light) {
      ...
      if (light instanceof DirectLight) {
        o3Math.Matrix.ortho(-5, 5, -5, 5, 0.1, 50, this.projectionMatrix);
      }
      /**
      ...
      if (light instanceof PointLight) {
        o3Math.Matrix.perspective(o3Math.MathUtil.degreeToRadian(50), 1, 0.5, 50, this.projectionMatrix);
      }
      /**
      ...
      if (light instanceof SpotLight) {
        ...
        o3Math.Matrix.perspective(fov, 1, 0.1, light.distance + 5, this.projectionMatrix);
      }
    }
    /**
     * 将阴影参数值提交到阴影材质对象
...
var ShadowFeature = /*#__PURE__*/function (_SceneFeature) {
  ...
  _createClass(ShadowFeature, [{
    ...
    value: function addShadowPass(camera) {
      var shadowMaterial = new ShadowMaterial("shadowMaterial");
