(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('oasis-engine'), require('@oasis-engine/tween')) :
  typeof define === 'function' && define.amd ? define(['exports', 'oasis-engine', '@oasis-engine/tween'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@oasisEngine/controls'] = {}, global.oasisEngine, global['@oasisEngine/tween']));
}(this, (function (exports, oasisEngine, tween$1) { 'use strict';
  ...
  var FreeControl = /*#__PURE__*/function (_Script) {
    ...
    function FreeControl(entity) {
      ...
      _this.tempVec3 = new oasisEngine.Vector3();
    ...
    _createClass(FreeControl, [{
      ...
      value: function rotate() {
        ...
        oasisEngine.Vector3.add(this.camera.position, this._v3Cache, this._v3Cache);
      ...
      value: function jump() {
        ...
        tween$1.doTransform.Translate(this.camera, new oasisEngine.Vector3(p.x, this.jumpY, p.z), this.jumpDuration / 2, {
          easing: tween$1.Easing.easeOutSine,
          onComplete: function onComplete() {
            tween$1.doTransform.Translate(_this2.camera, new oasisEngine.Vector3(p.x, _this2.floorY, p.z), _this2.jumpDuration / 2, {
              easing: tween$1.Easing.easeInSine,
              onComplete: function onComplete() {
      ...
      value: function translateOnAxis(axis, distance) {
        ...
        var diff = new oasisEngine.Vector3();
        oasisEngine.Vector3.normalize(axis, diff);
  ...
  var OrbitControl = /*#__PURE__*/function (_Script) {
    ...
    function OrbitControl(entity) {
      ...
      _this.target = new oasisEngine.Vector3(); // up向量

      _this.up = new oasisEngine.Vector3(0, 1, 0); // 最大最小距离
