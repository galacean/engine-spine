...
var miniprogram$1 = require('@oasis-engine/tween/dist/miniprogram');
...
var tween = new miniprogram$1.Tween();
/**
...
var FreeControl = /*#__PURE__*/function (_Script) {
  ...
  function FreeControl(entity) {
    ...
    _this.tempVec3 = new miniprogram.Vector3();
    ...
    _this._spherical = new miniprogram.Spherical();
  ...
  _createClass(FreeControl, [{
    ...
    value: function rotate() {
      ...
      miniprogram.Vector3.add(this.camera.position, this._v3Cache, this._v3Cache);
    ...
    value: function jump() {
      ...
      miniprogram$1.doTransform.Translate(this.camera, new miniprogram.Vector3(p.x, this.jumpY, p.z), this.jumpDuration / 2, {
        easing: miniprogram$1.Easing.easeOutSine,
        onComplete: function onComplete() {
          miniprogram$1.doTransform.Translate(_this2.camera, new miniprogram.Vector3(p.x, _this2.floorY, p.z), _this2.jumpDuration / 2, {
            easing: miniprogram$1.Easing.easeInSine,
            onComplete: function onComplete() {
    ...
    value: function translateOnAxis(axis, distance) {
      ...
      var diff = new miniprogram.Vector3();
      miniprogram.Vector3.normalize(axis, diff);
...
var OrbitControl = /*#__PURE__*/function (_Script) {
  ...
  function OrbitControl(entity) {
    ...
    _this.target = new miniprogram.Vector3(); // up向量

    _this.up = new miniprogram.Vector3(0, 1, 0); // 最大最小距离
    ...
    _this._spherical = new miniprogram.Spherical();
    _this._sphericalDelta = new miniprogram.Spherical();
    _this._sphericalDump = new miniprogram.Spherical();
    _this._zoomFrag = 0;
    _this._scale = 1;
    ...
    _this.addEventListener("disabled", function () {
      var element = _this.domElement === miniprogramAdapter.document ? _this.domElement.body : _this.domElement;
