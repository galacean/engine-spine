...
var nodeMajorVersion = parseInt(process.versions.node.split('.', 1)[0]);
...
var Compiler = Object.extend({
    ...
    compileLiteral: function(node, frame) {
        if(typeof node.value === 'string') {
            ...
            // http://gitlab.alipay-inc.com/chair/chair/issues/3022
            if (nodeMajorVersion < 10) val = val.replace(/\u2028/g, '\\u2028');
    ...
    _getNodeName: function(node) {
        switch (node.typename) {
            ...
            case 'Literal':
                // try to show more node name
                // fix `name["prototype"]["toString"]["constructo"]` => `name["prototype"]["toString"]["constructor"]`
